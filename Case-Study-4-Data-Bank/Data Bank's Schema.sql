...
CREATE TABLE
    data_bank.regions (region_id INTEGER, region_name VARCHAR(9));

-- Customer node allocation history
CREATE TABLE
...
INSERT INTO
    data_bank.regions (region_id, region_name)
VALUES
    (1, 'Africa'),
    (2, 'America'),
    (3, 'Asia'),
...
INSERT INTO
    data_bank.customer_transactions (customer_id, txn_date, txn_type, txn_amount)
VALUES
